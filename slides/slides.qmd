...
Let's go back to the Jacobi solver. Profiling with Nsight Systems[^1] gives the
following timeline:

![](media/nsight-systems-jacobi.png)

[^1]: This screenshot is taken from the ISC/SC Multi-GPU tutorial slides and was
generated on the JUWELS Booster system with Nvidia A100 40GB GPUS.
...
It's also possible to create streams with different priorities. 
CUDA has the following functions:
